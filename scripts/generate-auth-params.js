...
const username = process.env.APP_USER || 'admin@hel.fi';
const resource = process.env.APP_RESOURCE;
const organization = process.env.APP_ORGANISATION;
const now = new Date();
const createdAt = now.toJSON();
const validUntil =
  process.env.APP_VALID_UNTIL ||
