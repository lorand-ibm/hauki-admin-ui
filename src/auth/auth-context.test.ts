...
describe('Auth Context', () => {
  describe('parseAuthParams', () => {
    it('parses auth parameters from query string', () => {
      expect(
        parseAuthParams(
          '?username=admin@hel.fi&signature=1234567&valid_until=2020-11-05T16%3A20%3A00&created_at=2020-11-05T16%3A10%3A00&organization=12345&resource=tprek%3A8215&source=tprek'
        )
      ).toEqual({
